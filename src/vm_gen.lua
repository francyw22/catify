...
function VmGen.generate(proto, revmap, key, nonce, utils)
    ...
    LF("      local _vox_ok,_materials=pcall(function() local _region=_r3.new(_v3.new(0,900,0),_v3.new(4,904,4));local _mats=_terrain:ReadVoxels(_region,4);return _mats end)")
