...
local function main(argv)
    ...
    info("Protected with: opcode shuffle, ChaCha20 encryption, Base85 encoding, SHA-256 integrity, debug strip, junk injection (intensity %d), VM dispatch obfuscation, hookfunction/getgenv/debug.info anti-tamper", opts.intensity)
end
