...
local function main(argv)
    ...
    info("Protected with: opcode shuffle, AES-256-CTR encryption, SHA-256 integrity, debug strip, junk injection (intensity %d), VM dispatch obfuscation, stealth anti-tamper (includes debug.gethook/getinfo, string.dump, rawget checks)", opts.intensity)
end
