...
local function main(argv)
    ...
    info("Protected with: opcode shuffle, AES-256-CTR encryption, SHA-256 integrity, debug strip, junk injection (intensity %d), VM dispatch obfuscation, anti-tamper (14 checks), anti-env-logger (3 checks)", opts.intensity)
end
